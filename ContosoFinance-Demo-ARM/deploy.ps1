...
$subscriptionId = "972386bc-cd9b-425f-9e66-f9c9754bab9d" #insert your subscription ID
$resourceGroupName = "CIaCSBalaji-rg"  #provide resource group name
...
$templateFileURI = 'https://raw.githubusercontent.com/BalajiVerity/CIaCSTrainingARM/main/ContosoFinance-Demo-ARM/ARM-Templates/template.json'
$parametersFileURI = 'https://raw.githubusercontent.com/BalajiVerity/CIaCSTrainingARM/main/ContosoFinance-Demo-ARM/ARM-Templates/paramters.json'
