...
$templateFileURI = 'https://raw.githubusercontent.com/BalajiB13/CIaCSTrainingARM/main/ContosoFinance-Demo-ARM/ARM-Templates/template.json'
$parametersFileURI = 'https://raw.githubusercontent.com/BalajiB13/CIaCSTrainingARM/main/ContosoFinance-Demo-ARM/ARM-Templates/paramters.json'
